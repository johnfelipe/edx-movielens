...
This study is part of my capstone project for the HarvardX Data Science Specialization on edX. All work is my own. 


*** The GitHub repository for this project is located at: https://github.com/gillsignals/edx-movielens.git.    **
...
steps (EDA, data wrangling, model training, generation of predictions for grading.)
